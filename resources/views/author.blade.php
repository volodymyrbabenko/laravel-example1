<x-main-layout>
	<x-slot name="title">Михаил Русаков</x-slot>
	<x-slot name="description">Об авторе блога Русакове Михаиле Юрьевиче.</x-slot>
	<x-slot name="keywords">об авторе, михаил русаков, михаил юрьевич русаков</x-slot>
	<x-slot name="left">
		<div id="other">
            <h1>Об авторе</h1>
            <p class="center">
